...
public class PessoaTeste {
	...
	private EnderecoTeste endereco = new EnderecoTeste();
	
	public PessoaTeste() {
		
	}
	
	public PessoaTeste(String id, long idBanco, String nome, String email, String cpf, String dataNascimento, String telefone,
	...
	public PessoaTeste copy() {
		return new PessoaTeste(id, idBanco, nome, email, cpf, dataNascimento, telefone, telefone2,
